...
"")
        ...
        self.plainTextEdit_2.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByKeyboard|Qt.TextInteractionFlag.TextSelectableByMouse)
        ...
        icon = QIcon()
        icon.addFile(u"../../../../../Downloads/key_30dp_UNDEFINED_FILL0_wght400_GRAD0_opsz24.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.actionCriptografar.setText(QCoreApplication.translate("mainWindow", u"Criptografar", None))
        self.actionDescriptografar.setText(QCoreApplication.translate("mainWindow", u"Descriptografar", None))
        self.label_2.setText(QCoreApplication.translate("mainWindow", u"Mensagem", None))
        self.label_3.setText(QCoreApplication.translate("mainWindow", u"Mensagem Criptografada", None))
        self.label.setText(QCoreApplication.translate("mainWindow", u"->", None))
        self.plainTextEdit_2.setDocumentTitle("")
        self.lineEdit.setInputMask("")
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("mainWindow", u"Chave...", None))
#if QT_CONFIG(tooltip)
        self.toolButton.setToolTip(QCoreApplication.translate("mainWindow", u"Gerar Chave", None))
#endif // QT_CONFIG(tooltip)
        self.toolButton.setText(QCoreApplication.translate("mainWindow", u"...", None))
#if QT_CONFIG(shortcut)
        self.toolButton.setShortcut(QCoreApplication.translate("mainWindow", u"Ctrl+K", None))
#endif // QT_CONFIG(shortcut)
        self.pushButton.setText(QCoreApplication.translate("mainWindow", u"Criptografar", None))
