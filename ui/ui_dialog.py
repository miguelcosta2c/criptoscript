...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalSpacer_2 = QSpacerItem(
            20, 39, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.verticalSpacer = QSpacerItem(
            20, 73, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.buttonBox.setStandardButtons(QDialogButtonBox.StandardButton.Cancel |
                                          QDialogButtonBox.StandardButton.Ignore | QDialogButtonBox.StandardButton.SaveAll)
