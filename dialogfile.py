...
class Dialog(Ui_Dialog, QDialog):
    ...
    def config(self):
        ...
        self.buttonBox.button(QDialogButtonBox.Ignore).clicked.connect(self.ignorar)
    ...
    def script_file(self):
        ...
        self.label_5.setText(
            self.selecionar_caminho_arquivo(
                "Arquivo Criptografado (*.enc);;Todos os Arquivos (*)"
            )
        )
    ...
    def key_file(self):
        ...
        self.label_2.setText(
            self.selecionar_caminho_arquivo(
                "Arquivo de Chave (*.key);;Todos os Arquivos (*)"
            )
        )
